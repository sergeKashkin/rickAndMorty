      ...
      <body className={inter.className + " min-h-screen"}>
        <header>
          <div className="z-10 w-full flex flex-col bg-white items-center justify-between font-mono text-sm">
            <div className="fixed max-sm:bottom-0 max-md:bottom-0 z-50 left-0 flex h-12 w-full items-end justify-center bg-gradient-to-t from-white lg:bg-white via-white dark:from-black dark:via-black lg:fixed lg:top-0 lg:h-auto lg:w-full">
